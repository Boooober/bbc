...
<div class="section box-4" style="background-image: url('<?php echo $templateurl; ?>/assets/images/bbc_4.jpg');">
	<div class="box-container">
		<div class="box-head">
			<h2 class="box-title">The mobile application Bourbo</h2>
			<p>We are glad to introduce you to a new mobile application </p>
		</div>
		<div class="box-image">
...
<div class="section box-3" style="background-image: url('<?php echo $templateurl; ?>/assets/images/mob/bbc-3.jpg') ">
	<div class="box-container">
		...
		<div class="box-item"><span class="number">6</span> <span
				class="desc">years in a market of Luxury services</span></div>
		<div class="box-item"><span class="number">470</span> <span
				class="desc">client from 23 countries of the world</span></div>
		<div class="box-item"><span class="number"><span class="numbinc">24</span>/7</span> <span class="desc">client from 23 countries of the world</span>
		</div>
	</div>
</div>
		...
		<div class="box-content">
			<div class="contacts-list">
				...
				<div class="row">
					<div class="col">
						<div class="office">
							 <p>Europe Office</p><b>+ 33 753 67 43 42<br/><!--email@europe.com--></b>
						</div>
					</div>
					<div class="col">
						<div class="office">
